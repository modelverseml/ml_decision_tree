"""Entry point: run the full decision tree walkthrough.

    python main.py            # classification + regression walkthrough
    python main.py --plot     # also show the tree / metric plots
"""
